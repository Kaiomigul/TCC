"""
App Streamlit: estratégia Growth (top N = long, bottom N = short).
Controle de N (3 a 20, default 5): em cada período Long = N melhores crescimento, Short = N piores.
Mostra evolução em base 100 e view por trimestre (Buy vs Short).
Rebalanceamento a cada trimestre.
"""
import pandas as pd
import numpy as np
